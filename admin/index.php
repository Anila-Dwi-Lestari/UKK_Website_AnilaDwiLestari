...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="admin/images/logoNeubook.png">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
    ...
    <ul class="nav navbar-nav ">
      ...
      <li class="nav-item"><a class="nav-link" href="index.php?page=add-book"><i class="fa fa-user-plus"></i> Add Book</a></li>
...
<br>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="index.php?page=add-book" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i> Add Book</a>
              <a href="index.php?page=all-book" class="list-group-item list-group-item-action"><i class="fa fa-users"></i> All Book</a>
    ...
    <footer>
      <div class="container">
      <p>Copyright &copy; Anila Dwi Lestari to<?php echo date('Y') ?></p>
      </div>
    </footer>
